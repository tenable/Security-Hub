...
def test_transform_finding(sechub, asset, vulnerability):
    ...
    sechub._account_id = os.getenv('AWS_ACCOUNT_ID')
    ...
    assert f['ProductArn'] == 'arn:aws:securityhub:us-east-1:{}:product/tenable/tenable-io'.format(sechub._account_id)
    assert f['AwsAccountId'] == sechub._account_id
    ...
    assert f['Resources'][0]['Id'] == 'arn:aws:ec2:us-east-1:{}:instance:i-00f9e618482900000'.format(sechub._account_id)
